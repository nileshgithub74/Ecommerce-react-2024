...
const Popular = () => {
  ...
  const popular = all_product.filter((p) => p.category === 'women').slice(0, 8);

  return (
    <section className="py-16 px-4 sm:px-8 lg:px-16 max-w-7xl mx-auto">
      <div className="text-center mb-10">
        <span className="text-xs font-semibold text-red-500 uppercase tracking-widest">Trending Now</span>
        <h2 className="text-3xl font-bold text-gray-900 mt-1">Popular in Women</h2>
